...
function MobileNav() {
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 z-20 w-dvw overflow-hidden border-t border-walnut/20 bg-darkwood bg-cover bg-center bg-no-repeat px-2 pb-3 pt-2 font-ui text-cream md:hidden"
